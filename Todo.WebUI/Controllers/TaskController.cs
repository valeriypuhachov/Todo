...
namespace Todo.WebUI.Controllers {
    ...
    public class TaskController : Controller {
        ...
        [HttpPost]
        //public async Task<PartialViewResult> List(State? state, string place,
        //    DateTime? filterModel.MinTime, DateTime? filterModel.MaxTime, int page = 1) {
